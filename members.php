...
try {
    ...
    if ($debug) {
        ...
        echo "<p>SQL Sorgusu: SELECT COUNT(*) FROM users u WHERE 1=1 $searchCondition</p>";
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <div class="text-2xl font-bold text-gray-900 dark:text-white">
                            <?php
                            try {
                                $authorCount = $db->query("SELECT COUNT(DISTINCT user_id) FROM articles WHERE status = 'published'")->fetchColumn();
